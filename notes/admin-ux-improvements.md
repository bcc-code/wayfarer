...
| `challenges/new.vue`                    | `…/challenges/new`        | 178 | ◐   | Form restructured with it; renders the "quiz after creation" notice.                                                             |
| `challenges/[challengeId]/index.vue`    | `…/challenges/:id`        | 290 | ◐   | Header + sections + sticky preview; `endTime` restored; completion count.                                                        |
| `challenges/[challengeId]/quiz.vue`     | `…/:id/quiz`              | 407 | ◐   | Parallel saves with errors surfaced; reorder; dialog editing; validation.                                                        |
...
| `achievements/new.vue`                  | `…/achievements/new`      | 132 | ◐   | Form restructured with it.                                                                                                       |
| `achievements/[achievementId].vue`      | `…/achievements/:id`      | 362 | ◐   | Header + sections + sticky preview; award count; quiz selector rewritten.                                                        |
