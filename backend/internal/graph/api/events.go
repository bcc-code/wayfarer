...
// buildEventFilterParamsCursor converts GraphQL filter and cursor pagination params to database query parameters
func buildEventFilterParamsCursor(filter *model.EventFilter, first *int, after *string, last *int, before *string) (sqlc.GetEventsFilteredCursorParams, error) {
	params := sqlc.GetEventsFilteredCursorParams{}
...
// buildCountEventsFilterParams converts GraphQL filter to database count query parameters
func buildCountEventsFilterParams(filter *model.EventFilter) sqlc.CountEventsFilteredParams {
	params := sqlc.CountEventsFilteredParams{}
...
// buildEventCacheKeyParams converts filter and pagination parameters to a map for cache key generation
func buildEventCacheKeyParams(filter *model.EventFilter, first *int, after *string, last *int, before *string) map[string]string {
