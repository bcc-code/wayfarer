...
WHERE project_id = ANY(@entity_ids::char(28)[])
...
WHERE event_id = ANY(@entity_ids::char(28)[])
  AND language_code = @language_code::text;
...
WHERE challenge_id = ANY(@entity_ids::char(28)[])
  AND language_code = @language_code::text;
