...
VALUES (@id::text, @key::text, @version::int, @title::text, @short_text::text, @body::text, @url, @button_text, @published_at, @is_remote::bool, @managed_by)
...
UPDATE consents SET
    ...
    button_text = CASE WHEN @button_text::text = '' THEN button_text ELSE @button_text END,
...
VALUES (@consent_id::text, @language_code::text, @title, @short_text, @body, @button_text)
